...
const handleSubmit = async e =>{
  ...
  return (
    ...
    ? 
    <div className=" ">
    <div className="title text-md font-regular font-nunito">Según la siguiente escala, <span className='text-lila-300'>¿qué tan conforme estás con la calidad del sueño?</span> </div>
