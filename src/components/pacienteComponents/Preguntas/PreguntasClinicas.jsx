...
const handleSubmit = async e =>{
  ...
  return (
    ...
    ? 
    <div className="  ">
    <div className="title  text-sm font-regular font-nunito">Según la siguiente escala, <span className='text-lila-300'>¿cómo has sentido tu salud general estas semanas?</span> </div>
