...
<div >
    ...
    ?
<div className="">
<div className=" text-lila-300  title text-md font-semibold font-nunito">Usted consume alcohol?</div>
...
<div className='p-1'> 
   <button className="   bg-lila-200 px-2 py-2 text-white rounded-md text-center  font-nunito  hover:bg-indigo-400 ">Guardar💾</button>
    ...
    <div>     
    <div className='  '>
      <div className='bg-white  border-gray-200 rounded-lg p-2 text-center'>
      <h1 className='px-1 mt-1  font-nunito'> { auth.historiaclinica?.alcohol==='Si' ?
      
      <div className=''>
      <h1 className='font-bold '> Alcoholismo: </h1>
      <span className=' font-bold text-green-700'> Si consume alcohol</span>
      <div className='flex justify-center'>  <span className='text-3xl'>🍺</span></div>
      </div>
      :
      <div className=''>
      <h1 className='font-bold '>Alcoholismo: </h1>
      <span className=' font-bold text-green-700'>No consume alcohol</span>
      <div className='flex justify-center'>  <span className='text-3xl'>🚫</span></div>
      </div>
