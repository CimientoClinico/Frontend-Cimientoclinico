...
const handleSubmit = async e =>{
  ...
  return (
    ...
    ? 
    <div className="">
    <div className="title text-md font-regular font-nunito">Según la siguiente escala <span className='text-lila-300'>¿cómo considera que ha estado su salud mental las últimas semanas?</span> </div>
