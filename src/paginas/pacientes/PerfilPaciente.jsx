...
const fotoPerfil = async (e)  =>{
 ...
 const { msgp } = alertap
  return (
    ...
    <div className="bg-teal-600 margen  py-3 pb-8 shadow-md  dark:bg-slate-700  ">
      <Link to="/paciente/perfil-paciente"> <h2 className="xl:px-10 text-md text-nunito  hover:underline hover:text-white dark:text-white ">Perfil de usuario</h2></Link>
  <h1 className="text-left xl:px-64 mt-4 font-regular font-nunito text-4xl dark:text-white shado"><span className="font-semibold"> {auth.nombres} {auth.apellidos}  </span> </h1>
       </div>
...
<div className="">
            ...
            <div className="flex justify-center -full">
                ...
                <label className="block mb-2 text-sm font-bold text-gray-900 font-nunito dark:text-white" >Sube tu foto de perfil</label>
                    ...
                    <button type="submit" className=" text-xs text-white bg-teal-600 py-2 px-4 rounded-md mt-1 hover:bg-teal-700">Subir foto</button>
                   </form>
        ...
        <div className="mt-2 text-center">
            ...
            <h3 className=" text-2xl font-semibold font-nunito text-teal-800 dark:text-gray-300"> {auth.nombres} {auth.apellidos} </h3>
...
<div className=" dark:bg-slate-300 mx-auto md:max-w-2xl  min-w-0 break-worsd bg-white w-full mb-6 shadow-lg rounded-xl mt-10">
    <div className="px-6">
        ...
        <div className="text-center mt-2 lg:px-12 sm:px-0">
            <h3 className="text-2xl text-teal-600 font-nunito font-bold py-2 mb-1">Datos de tu perfil</h3>
            ...
            <div className="flex items-center border-2 mb-10 py-2 px-3 rounded-2xl">
                ...
                className="  dark:bg-slate-300 font-normal text-sm  font-nunito  pl-2 w-full outline-none border-none"
                 type="text"
                  ...
                  <button  className="text-sm text-gray-100 bg-teal-600 hover:bg-teal-700 pt-1 pb-1 pl-2 pr-2 rounded-lg ">Actualizar</button>
...
<div className="relative  dark:bg-slate-300 mx-auto md:max-w-2xl  min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl mt-10">
    <div className="px-6">
        ...
        <div className="text-center mt-2 lg:px-12 sm:px-0">
            ...
            <h3 className="text-2xl  text-teal-600 font-nunito font-bold py-2 mb-1">Cambia tu contraseña</h3>
            {msgp && <AlertaP
              alertap={alertap}
              />}
            ...
            {showPwd3 ? <svg  className="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height={"1.2rem"}>
              ...
              <button  type="submit" className=" bg-teal-600 block w-full font-nunito py-2 rounded-2xl hover:bg-teal-700 hover:-translate-y-1 transition-all duration-300 text-white font-semibold mb-2">Actualizar contraseña</button>
